...
<html>
    ...
    <div style="width: 49%; float:left">
        ...
        <center><b>Registrati</b></center>
        <form role="form" method="post" action="registrazione.php" autocomplete="off">
            <div class="form-group">
                <input type="text" name="usern" id="usern" class="form-control input-lg" placeholder="User Name" value="junkex2">
            </div>
            ...
            <div class="form-group">
                <input type="text" name="ref_code" id="ref_code" class="form-control input-lg" placeholder="ref_code" value="">
            </div>
        ...
        <center><b>InsertPunteggio</b></center>
        <form role="form" method="post" action="InsertPunteggio.php" autocomplete="off">
            <div class="form-group">
                <input type="text" name="usern" id="usern" class="form-control input-lg" placeholder="User Name" value="junkex2">
            </div>
        ...
        <center><b>deviceINfo</b></center>
        <form role="form" method="post" action="setDeviceInfo.php" autocomplete="off">
            <div class="form-group">
                <input type="text" name="info" id="info" class="form-control input-lg" placeholder="info" value="">
            </div>
        ...
        <center><b>ottieniClassifica</b></center>
        <form role="form" method="post" action="ottieniClassifica.php" autocomplete="off">
            <div class="form-group">
                <input type="text" name="tipo" id="tipo" class="form-control input-lg" placeholder="tipo" value="day">
            </div>
            <div class="form-group">
                <input type="text" name="nazione" id="nazione" class="form-control input-lg" placeholder="nazione" value="IT">
            </div>
        ...
        <center><b>setCheater</b></center>
        <form role="form" method="post" action="setCheater.php" autocomplete="off">
            <div class="form-group">
                <input type="text" name="usern" id="usern" class="form-control input-lg" placeholder="usern" value="junkex2">
            </div>
            <div class="form-group">
                <input type="password" name="password" id="password" class="form-control input-lg" placeholder="password" value="asd1asd">
            </div>
            <div class="form-group">
                <input type="text" name="punteggio" id="punteggio" class="form-control input-lg" placeholder="punteggio" value="11">
            </div>
            <div class="row">
                <div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="Testa" class="btn btn-primary btn-block btn-lg"></div>
            </div>
    ...
    <center><b>Ruota</b></center>
        <form role="form" method="post" action="ruota.php" autocomplete="off">
            <div class="form-group">
                <input type="text" name="usern" id="usern" class="form-control input-lg" placeholder="User Name" value="junkex2">
            </div>
            ...
            <div class="form-group">
                <input type="text" name="ruota" id="ruota" class="form-control input-lg" placeholder="ruota" value="1">
            </div>
            <div class="row">
                <div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="Testa" class="btn btn-primary btn-block btn-lg"></div>
            </div>
        ...
        <form role="form" method="post" action="setCurrentSkin.php" autocomplete="off">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <input type="text" name="player" id="player" class="form-control input-lg" placeholder="player" value="EXPR">
            </div>

             <div class="form-group">
                <input type="text" name="bus" id="bus" class="form-control input-lg" placeholder="bus" value="AIRB">
            </div>
            <div class="row">
                <div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="Testa" class="btn btn-primary btn-block btn-lg"></div>
            </div>
