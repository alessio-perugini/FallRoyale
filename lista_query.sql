...
CREATE TABLE rewards_season(
    id INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    data TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    id_punteggi_fk INT NOT NULL,
    id_premi_fk INT NOT NULL,
    id_utente_fk INT NOT NULL,

    CONSTRAINT fk_rewards_season_punteggi FOREIGN KEY (id_punteggi_fk) REFERENCES punteggi(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_rewards_season_utente FOREIGN KEY (id_utente_fk) REFERENCES utenti(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_rewards_season_premi FOREIGN KEY (id_premi_fk) REFERENCES premi(id) ON DELETE CASCADE ON UPDATE CASCADE
);