    ...
    <body>
        ...
        <form role="form" method="post" action="crea_codici.php" autocomplete="off">
            <div class="form-group">
                <input type="text" name="n_codici" id="n_codici" class="form-control input-lg" placeholder="n_codici" value="">
            </div>

            <div class="form-group">
                <input type="text" name="valore" id="valore" class="form-control input-lg" placeholder="valore" value="">
            </div>
            <div class="form-group">
                <input type="text" name="scadenza" id="scadenza" class="form-control input-lg" placeholder="scadenza" value="">
            </div>
            <div class="form-group">
        ...
        <form role="form" method="post" action="inserisci_skin.php" autocomplete="off">
            ...
            <hr>                  
		        ...
		        <center><b>Mostra codici non riscattati</b></center>
        <form role="form" method="post" action="showcodes.php" autocomplete="off">
            <div class="row">
                <div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="Testa" class="btn btn-primary btn-block btn-lg"></div>
            </div>
            <hr>                  
